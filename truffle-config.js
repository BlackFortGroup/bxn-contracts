...
const tools = require('ethereum-mnemonic-privatekey-utils');
tools.debug = false;
const keystores = [
]
const privateKeyParsed = [
    tools.getPrivateKeyFromKeystore(keystores[6], 'password'),
]
...
module.exports = {
  ...
  networks: {
    ...
    testnet: {
      provider: () => new HDWalletProvider(privateKeyParsed, ""),
      network_id: "4999",       // Any network (default: none)
